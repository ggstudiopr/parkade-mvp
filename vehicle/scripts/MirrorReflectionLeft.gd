...
@onready var MIRROR_SCREEN :=$"../../MirrorScreenLeft" #Sprite 3D Asset, just load any texture onto it
@onready var SUBVIEW_DISPLAY_LEFT := $".." #subview texture is based on phone camera child (this node)
